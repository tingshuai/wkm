    ...
    <div class="search">
        ...
        <el-form :inline="true"  ref="form" :model="data" label-width="110px" v-for="ary in config">
            <el-form-item style="height:46px;" :label="item.label" size="mini" v-for="(item,index) in ary">
                ...
                <el-date-picker :disabled="item.disabled" range-separator="至" v-if="item.type=='daterange'||item.type=='date'" :type="item.type"  v-model="data[item.field]"  value-format="yyyy-MM-dd"></el-date-picker>
